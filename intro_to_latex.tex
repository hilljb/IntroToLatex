...
% intro_to_latex.tex
% Jason B. Hill (jason@jasonbhill.com) www.github.com/hilljb
% April 2014
...
% set the default paragraph indent (do not indent)
\setlength\parindent{0pt}

% these control the section, corollary, and lemma displays in the amsthm package
...
% create the table of contents; starting on the front page
\tableofcontents

% don't place page numbers on this page
\thispagestyle{empty}

% start a new page and begin page numbering at 1
\newpage
\setcounter{page}{1}
